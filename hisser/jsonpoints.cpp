...
static PyObject *__pyx_f_6hisser_10jsonpoints_mean(PyObject *, int __pyx_skip_dispatch); /*proto*/
...
static PyObject *__pyx_pf_6hisser_10jsonpoints_2mean(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_values); /* proto */
/* Late includes */

/* "hisser/jsonpoints.pyxx":22
 ...
 *     cdef PyObject* vo
 */
  __pyx_t_1 = PyObject_Length(__pyx_v_values); if (unlikely(__pyx_t_1 == ((Py_ssize_t)-1))) __PYX_ERR(0, 25, __pyx_L1_error)
  __pyx_v_length = __pyx_t_1;

  /* "hisser/jsonpoints.pyxx":29
 *     cdef PyObject* vo
 *     cdef char buf[BLEN]
 *     cdef size_t bpos = 0             # <<<<<<<<<<<<<<
 *     result = []
 ...
 * 
 */
      __pyx_t_2 = __Pyx_PyBytes_FromStringAndSize(((const char*)__pyx_v_buf) + 0, __pyx_v_bpos - 0); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 56, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
      __pyx_t_7 = __Pyx_PyList_Append(__pyx_v_result, __pyx_t_2); if (unlikely(__pyx_t_7 == ((int)-1))) __PYX_ERR(0, 56, __pyx_L1_error)
 ...
 *         result.append(b']')
 */
    __pyx_t_2 = __Pyx_PyBytes_FromStringAndSize(((const char*)__pyx_v_buf) + 0, __pyx_v_bpos - 0); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 62, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_7 = __Pyx_PyList_Append(__pyx_v_result, __pyx_t_2); if (unlikely(__pyx_t_7 == ((int)-1))) __PYX_ERR(0, 62, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  /*else*/ {
    __pyx_t_7 = __Pyx_PyList_Append(__pyx_v_result, __pyx_kp_b_); if (unlikely(__pyx_t_7 == ((int)-1))) __PYX_ERR(0, 64, __pyx_L1_error)
  }
  __pyx_L8:;

  /* "hisser/jsonpoints.pyxx":66
 *         result.append(b']')
 * 
 *     if len(result) == 1:             # <<<<<<<<<<<<<<
 *         return result[0]
 *     else:
 */
  __pyx_t_1 = PyList_GET_SIZE(__pyx_v_result); if (unlikely(__pyx_t_1 == ((Py_ssize_t)-1))) __PYX_ERR(0, 66, __pyx_L1_error)
 ...
 */
    ...
    if (!(likely(PyBytes_CheckExact(PyList_GET_ITEM(__pyx_v_result, 0)))||((PyList_GET_ITEM(__pyx_v_result, 0)) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "bytes", Py_TYPE(PyList_GET_ITEM(__pyx_v_result, 0))->tp_name), 0))) __PYX_ERR(0, 67, __pyx_L1_error)
 ...
 */
  /*else*/ {
    __Pyx_XDECREF(__pyx_r);
    __pyx_t_2 = __Pyx_PyBytes_Join(__pyx_kp_b__2, __pyx_v_result); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 69, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    if (!(likely(PyBytes_CheckExact(__pyx_t_2))||((__pyx_t_2) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "bytes", Py_TYPE(__pyx_t_2)->tp_name), 0))) __PYX_ERR(0, 69, __pyx_L1_error)
...
static PyObject *__pyx_pw_6hisser_10jsonpoints_1datapoints_to_json(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("datapoints_to_json (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_start)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("datapoints_to_json", 1, 3, 3, 1); __PYX_ERR(0, 22, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_step)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("datapoints_to_json", 1, 3, 3, 2); __PYX_ERR(0, 22, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "datapoints_to_json") < 0)) __PYX_ERR(0, 22, __pyx_L3_error)
      }
    ...
    __pyx_v_start = __Pyx_PyInt_As_uint32_t(values[1]); if (unlikely((__pyx_v_start == ((uint32_t)-1)) && PyErr_Occurred())) __PYX_ERR(0, 22, __pyx_L3_error)
    __pyx_v_step = __Pyx_PyInt_As_uint32_t(values[2]); if (unlikely((__pyx_v_step == ((uint32_t)-1)) && PyErr_Occurred())) __PYX_ERR(0, 22, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("datapoints_to_json", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 22, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("hisser.jsonpoints.datapoints_to_json", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
...
static PyObject *__pyx_pf_6hisser_10jsonpoints_datapoints_to_json(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_values, uint32_t __pyx_v_start, uint32_t __pyx_v_step) {
  ...
  __Pyx_RefNannySetupContext("datapoints_to_json", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_6hisser_10jsonpoints_datapoints_to_json(__pyx_v_values, __pyx_v_start, __pyx_v_step, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 22, __pyx_L1_error)
...
static PyObject *__pyx_pw_6hisser_10jsonpoints_3mean(PyObject *__pyx_self, PyObject *__pyx_v_values); /*proto*/
static PyObject *__pyx_f_6hisser_10jsonpoints_mean(PyObject *__pyx_v_values, CYTHON_UNUSED int __pyx_skip_dispatch) {
  size_t __pyx_v_i;
  size_t __pyx_v_length;
  PyObject *__pyx_v_vo;
 ...
 *     cdef PyObject* vo
 */
  __pyx_t_1 = PyObject_Length(__pyx_v_values); if (unlikely(__pyx_t_1 == ((Py_ssize_t)-1))) __PYX_ERR(0, 77, __pyx_L1_error)
  __pyx_v_length = __pyx_t_1;

  /* "hisser/jsonpoints.pyxx":80
 *     cdef double v
 *     cdef PyObject* vo
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_6 = PyFloat_FromDouble((__pyx_v_total / ((double)__pyx_v_non_empty))); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 89, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_AddTraceback("hisser.jsonpoints.mean", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static PyObject *__pyx_pw_6hisser_10jsonpoints_3mean(PyObject *__pyx_self, PyObject *__pyx_v_values); /*proto*/
static PyObject *__pyx_pw_6hisser_10jsonpoints_3mean(PyObject *__pyx_self, PyObject *__pyx_v_values) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("mean (wrapper)", 0);
  __pyx_r = __pyx_pf_6hisser_10jsonpoints_2mean(__pyx_self, ((PyObject *)__pyx_v_values));
...
static PyObject *__pyx_pf_6hisser_10jsonpoints_2mean(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_values) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("mean", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_6hisser_10jsonpoints_mean(__pyx_v_values, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 75, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyMethodDef __pyx_methods[] = {
  ...
  {"mean", (PyCFunction)__pyx_pw_6hisser_10jsonpoints_3mean, METH_O, 0},
  {0, 0, 0, 0}
};
